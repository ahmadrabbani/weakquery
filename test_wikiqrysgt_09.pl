...
sub getPageid {
	...
	#print LOG "page mysql topic: " . $mysql_topic . "\n";
...
sub wikiDisambiguation {
	...
	if (keys(%overlap_link_withcontext)>0){
		...
		if (keys(%tf_withcontext) > 0){
			...
			print LOG "context_result: $context_result" . "\n\n"; 
			...
			print LOG "count_result: $count_result" . "\n\n";
			return $count_result;
		}
	}
...
sub outputWSDresult {
	...
	print LOG "link_result: $link_result\n";
	...
	if (keys(%tf_withcontext) > 0){
		...
		print LOG "definition_result: $result_definition\n";
	}
	else {
		print LOG "definition_result: null!!!\n";
	}
