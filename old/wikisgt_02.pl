...
#	there could be mltiple topics per query given their p(ti|Cti) is close
# --------------------
...
# ver1.1	4/25/2011
# TODO:
#	update result: contain multiple topics given their p(ti|Cti) is close or above threshold
