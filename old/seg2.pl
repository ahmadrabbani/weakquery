...
#TODO:thresholds and their values
my $maxhtmN      = 100;
my $MI_threshold = 0.0;                      #word level
...
#TODO:use the answer in the input file to calculate the accuracy of segmentation
	...
	#TODO: use Google to calculate MI in the scale of page
	# another MI is calculated with Wikipedia first paragraph
	...
	#TODO: is queryWikipedia really necessary?
...
# TODO: results follow the format of Bergsma & Wang, such as: "coney island" "new york"
	...
	if ( $n == 2 ) {
		$qryseg_str = &segByMI( $word, $outd2, $MI_threshold );
