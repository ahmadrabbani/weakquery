...
# OUTPUT:    
#   $ddir/results(_new)/$qtype/trecfmt(x)/$arg3.R$arg8/rset8/$runname-$arg4.1
#     -- results w/ topic reranking scores
#        QN docID RANK RT_SC RunName Topic_SCs (per line)
#   $ddir/results(_new)/$qtype/trecfmt(x)/$arg3.R$arg8/rset8/$runname-$arg4.2
#     -- results w/ opinion reranking scores
#        QN docID RANK RT_SC RunName Opinion_SCs (per line)
#   $ddir/results/$arg3/tmp/rrsc8$arg8(x)/$arg2-$runname-$arg4.1
#     -- new qry-independent scores file
#        docID SCOREs (per line)
#   $ddir/results/$arg3/tmp/rrsc8$arg8(x)/$arg2-$runname-$arg4.2
...
my $outd= "$r0d/rset8";         # !!rerank result file directory
