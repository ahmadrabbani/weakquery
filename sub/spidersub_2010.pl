...
###########################################################
#----------------------------------------------------------
# Update Google and Wikipedia parsing routines with latest tags
# Hui Zhang 11/23/2010
#----------------------------------------------------------
...
use lib '/home/huizhang/workspace/epic_prog/sub';
use lib '/home/hz3/workspace/epic_prog/sub';
use lib 'C:/Users/hz3/workspace/epic_prog/sub';
use Sentry;
...
sub queryWikipedia {
    ...
    my $body;
    if ($text=~/$begT(.+?)$endT/is) { $body=$1; }    #get all text in the entry page
    #if ($text=~/$begT(.+?)$endT1/is) { $body=$1; }	#get the summary section on top of the entry page
